...
/*   Updated: 2021/01/27 14:22:39 by ccardozo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	x1 = (pos->sp[i].pos.x - (int)pos->tile.size / 2) - pos->player.pos.x;
...
{
	x2 = (pos->sp[i].pos.x + (int)pos->tile.size / 2) - pos->player.pos.x;
